...
const Endpoint1_0 = (raw: RawClient["server.push"]) => () =>
  raw["push.publicKey"]({}).pipe(Effect.mapError(mapClientError))

type Endpoint1_1Request = Parameters<RawClient["server.push"]["push.subscription.register"]>[0]
type Endpoint1_1Input = {
  readonly endpoint: Endpoint1_1Request["payload"]["endpoint"]
  readonly expirationTime?: Endpoint1_1Request["payload"]["expirationTime"]
  readonly keys: Endpoint1_1Request["payload"]["keys"]
}
const Endpoint1_1 = (raw: RawClient["server.push"]) => (input: Endpoint1_1Input) =>
  raw["push.subscription.register"]({
    payload: { endpoint: input["endpoint"], expirationTime: input["expirationTime"], keys: input["keys"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint1_2Request = Parameters<RawClient["server.push"]["push.subscription.remove"]>[0]
type Endpoint1_2Input = { readonly endpoint: Endpoint1_2Request["payload"]["endpoint"] }
const Endpoint1_2 = (raw: RawClient["server.push"]) => (input: Endpoint1_2Input) =>
  raw["push.subscription.remove"]({ payload: { endpoint: input["endpoint"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup1 = (raw: RawClient["server.push"]) => ({
  publicKey: Endpoint1_0(raw),
  register: Endpoint1_1(raw),
  remove: Endpoint1_2(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  push: adaptGroup1(raw["server.push"]),
